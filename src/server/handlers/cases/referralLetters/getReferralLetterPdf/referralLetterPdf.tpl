  ...
  <body>
    <div id="pageHeader-first">
      <div style="text-align: center;">
        <img style="max-width: 223px" src="file:/app/src/instance_files/header_text.png" />
      </div>
      <div style="text-align: center; margin-top: 8px">
        <img style="max-width: 42px" src="file:/app/src/instance_files/icon.ico" />
      </div>
    </div>
    ...
    <div id="pageFooter" style="text-align: center; margin-top: 16px">
            <span  style="display:inline-block; margin: 6px 16px 0 0">
                <img style="max-width: 30px" src="file:/app/src/instance_files/icon.ico" />
            </span>
