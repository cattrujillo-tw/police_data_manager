...
const validate = values => {
  const errors = {};
  if (!values.firstReviewer) {
    errors.firstReviewer = firstReviewerRequired();
  }
  if (!values.secondReviewer) {
    console.log("Second reviewer missing...");
    errors.secondReviewer = secondReviewerRequired();
  } else if (values.firstReviewer === values.secondReviewer) {
    console.log("Comparing reviewers");
    errors.secondReviewer =
